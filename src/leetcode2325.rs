...
mod tests {
    ...
    fn leetcode2325_case1() {
        let message: String = String::from("the quick brown fox jumps over the lazy dog");
        let key: String = String::from("vkbs bs t suepuv");
        let desired = String::from("this is a secret");

        assert_eq!(solution(message, key), desired);
    }
}
